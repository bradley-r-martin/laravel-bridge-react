    ...
    <div className="flex flex-col space-y-1">
      ...
      <div className="grid grid-cols-2 gap-1">
        ...
        <div
          className={`${
            isMounting
              ? "animate-pulse bg-amber-400 text-amber-700"
              : "bg-slate-100 text-slate-300"
          } text-xs px-2 p-1 relative z-20`}
        >
          M
        ...
        <div
          className={`${
            isSyncing
              ? "animate-pulse bg-pink-400 text-pink-700"
              : "bg-slate-100 text-slate-300"
          } text-xs px-2 p-1 relative z-20`}
        >
          S
        ...
        <div
          className={`${
            isDispatched
              ? "animate-pulse bg-sky-400 text-sky-700"
              : "bg-slate-100 text-slate-300"
          } text-xs px-2 p-1 relative z-20`}
        >
          D
        ...
        <div
          className={`${
            isQueued
              ? "animate-pulse bg-rose-400 text-rose-700"
              : "bg-slate-100 text-slate-300"
          } text-xs px-2 p-1 relative z-20`}
        >
          Q
